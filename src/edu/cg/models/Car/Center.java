...
public class Center implements IRenderable, IIntersectable {
	...
	/** WHICH POINT???*/
	private BoundingSphere boundingSphere  = new BoundingSphere(1.06*Specification.C_HIEGHT, new Point(0,0.3 * Specification.C_HIEGHT,0));
	...
	public BoundingSphereTree getBoundingSpheres() {
		this.boundingSphere.setSphereColore3d(0,1,0);
